    ...
    return (
        <div className="container">
            ...
            <div className="support-section">
                <img src="http://localhost:5000/uploads/myImage-1713503588273.jpg" alt="Support Center Image" style={{ width: '100%', maxWidth: '400px', display: 'block', margin: '0 auto 20px' }} />
